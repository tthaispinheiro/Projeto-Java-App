...
public class Pessoa {
	...
	public boolean verificarCodSeguranca() { // VERIFICAR COD DE SEGURANÇA - DANDO BUG
	...
	public boolean verificarDataValidade() { // VERIFICAR VALIDADE

		if (validadeCartao.length() == 5 && validadeCartao.charAt(2) == '/') {
	...
	public boolean VerificartitularDoCartao() {  //VERIFICAR TITULAR DO CARTAO

		if (titulardoCartao.contains("#")) { // TIANA P SANTOS

			return false;
		}

		if (titulardoCartao.contains("!")) {
