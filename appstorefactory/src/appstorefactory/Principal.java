	...
	public static void main(String[] args) {
		...
		do {
			...
			case "3": { // CADASTRAR CARTÃO PESSOA FISICA
				...
				System.out.print("Informe o cpf que deseja cadastrar o cartão: " + "Formato: 000.000.000-00");																							// USUARIO
			...
			case "4": { // CADASTRAR CARTÃO PESSOA JURIDICA
				...
				if (cnpjProcurado.equalsIgnoreCase(cnpjProcurado)) {
					...
					do {
						...
						System.out.print("Número do cartão: " + "Formato: 0000 0000  0000 0000"); // NUMERO DO CARTÃO
					...
					do {
						...
						System.out.print("Código de segurança : " + "Formato: 155");
						cdCartao.setCodSeguranca(Integer.parseInt(ler.nextLine().trim()));
					...
					System.out.print("Titular do Cartão: " + "Formato: JOAO S SILVA");
					cdCartao.setTitulardoCartao(ler.nextLine().trim());
			...
			case "5": {// CADASTRAR APLICATIVO GRATUITO
				...
				System.out.print("Versão:  " + "Formato: 1.0"); // VERSÃO
			...
			case "6": { // CADASTRAR APP PAGO
				...
				do {
					...
					System.out.print("Versão:  " + "Formato: 2.0"); // VERSAO
